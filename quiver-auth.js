module.exports = function (serialize, deserialize) {
...
//   serialized and deserialized.
  passport.serializeUser(serialize || function(user, done) {
    done(null, user);
  });

  passport.deserializeUser(deserialize || function(obj, done) {
    done(null, obj);
  });
